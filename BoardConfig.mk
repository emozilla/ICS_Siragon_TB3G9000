...
-include vendor/siragon/duke/BoardConfigVendor.mk

TARGET_BOARD_PLATFORM := tegra
TARGET_BOARD_INFO_FILE := device/siragon/duke/board-info.txt
...
TARGET_BOOTLOADER_BOARD_NAME := duke
...
BOARD_KERNEL_CMDLINE := nvmem=128M@384M mem=1023M@0M vmalloc=256M video=tegrafb tegra_fbmem=8410464@0x1d7f6000 console=none usbcore.old_scheme_first=1 brand=siragon lp0_vec=8192@0x1fbed000 tegraboot=sdmmc gpt
...
BOARD_EGL_CFG := device/siragon/duke/egl.cfg
TARGET_OTA_ASSERT_DEVICE := duke,ventana
